...
public class HyperCreepersSoulItem extends Item {
	public HyperCreepersSoulItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.extreme_monsters.hyper_creepers_soul.description_0"));
	}
