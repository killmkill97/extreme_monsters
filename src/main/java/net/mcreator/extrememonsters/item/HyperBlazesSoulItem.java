...
public class HyperBlazesSoulItem extends Item {
	public HyperBlazesSoulItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.extreme_monsters.hyper_blazes_soul.description_0"));
	}
