...
public class HyperZombiesSoulItem extends Item {
	public HyperZombiesSoulItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.extreme_monsters.hyper_zombies_soul.description_0"));
	}
