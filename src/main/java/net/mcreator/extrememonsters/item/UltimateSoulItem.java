...
public class UltimateSoulItem extends Item {
	public UltimateSoulItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.extreme_monsters.ultimate_soul.description_0"));
		list.add(Component.translatable("item.extreme_monsters.ultimate_soul.description_1"));
	}
