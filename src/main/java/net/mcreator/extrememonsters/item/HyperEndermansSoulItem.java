...
public class HyperEndermansSoulItem extends Item {
	public HyperEndermansSoulItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.extreme_monsters.hyper_endermans_soul.description_0"));
	}
