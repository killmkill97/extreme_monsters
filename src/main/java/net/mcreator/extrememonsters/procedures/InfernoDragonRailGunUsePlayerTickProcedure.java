...
@EventBusSubscriber
public class InfernoDragonRailGunUsePlayerTickProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		double scale = 0;
		if (entity.getPersistentData().getBoolean("EM_inferno_dragon_rail_gun_charging") && (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ExtremeMonstersModItems.INFERNO_RAIL_GUN.get()) {
			entity.getPersistentData().putDouble("EM_inferno_dragon_rail_gun_charging_tick", (entity.getPersistentData().getDouble("EM_inferno_dragon_rail_gun_charging_tick") + 1));
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.ELECTRIC_SPARK, x, y, z, 4, 1, 1, 1, 0.2);
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("extreme_monsters:reactor_buzzing")), SoundSource.PLAYERS,
							(float) (entity.getPersistentData().getDouble("EM_inferno_dragon_rail_gun_charging_tick") * 0.02 * 0.1), (float) (entity.getPersistentData().getDouble("EM_inferno_dragon_rail_gun_charging_tick") * 0.02));
				} else {
					_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("extreme_monsters:reactor_buzzing")), SoundSource.PLAYERS,
							(float) (entity.getPersistentData().getDouble("EM_inferno_dragon_rail_gun_charging_tick") * 0.02 * 0.1), (float) (entity.getPersistentData().getDouble("EM_inferno_dragon_rail_gun_charging_tick") * 0.02), false);
				}
			}
			if (entity.getPersistentData().getDouble("EM_inferno_dragon_rail_gun_charging_tick") >= 100) {
				entity.getPersistentData().putBoolean("EM_inferno_dragon_rail_gun_charging", false);
				entity.getPersistentData().putDouble("EM_inferno_dragon_rail_gun_charging_tick", 0);
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.LAVA, x, y, z, 150, 1, 1, 1, 0.2);
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.ELECTRIC_SPARK, x, y, z, 150, 1, 1, 1, 0.4);
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.FIREWORK, x, y, z, 50, 1, 1, 1, 0.2);
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.FALLING_LAVA, x, y, z, 40, 1, 1, 1, 0.2);
				if (world instanceof ServerLevel _level)
				...
				if (new Object() {
					...
					if (entity instanceof Player _player)
						_player.getCooldowns().addCooldown(ExtremeMonstersModItems.INFERNO_RAIL_GUN.get(), 300);
				}
				if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof InfernoRailGunItem)
				...
				for (int index0 = 0; index0 < 500; index0++) {
					if (!world
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles(ParticleTypes.GUST_EMITTER_LARGE,
						...
						}
						{
							...
							for (Entity entityiterator : _entfound) {
								if (entityiterator instanceof EnderDragon) {
									if ((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) > 100) {
										if (entityiterator instanceof LivingEntity _entity)
											_entity.setHealth((float) ((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) - 100));
										if (world instanceof Level _level) {
											if (!_level.isClientSide()) {
									...
									entityiterator.hurt(new DamageSource(world.holderOrThrow(DamageTypes.GENERIC)), 150);
									if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
										_entity.addEffect(new MobEffectInstance(ExtremeMonstersModMobEffects.BLACK_HOLE, 200, 2));
									if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
										_entity.addEffect(new MobEffectInstance(ExtremeMonstersModMobEffects.MELT, 200, 4));
									if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
										_entity.addEffect(new MobEffectInstance(ExtremeMonstersModMobEffects.UNRESURRECT, 200, 4));
								}
							}
						}
						break;
					...
					if (world instanceof ServerLevel _level)
						_level.sendParticles(ParticleTypes.TRIAL_SPAWNER_DETECTED_PLAYER,
								(entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(scale)), ClipContext.Block.VISUAL, ClipContext.Fluid.NONE, entity)).getBlockPos().getX()),
								(entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(scale)), ClipContext.Block.VISUAL, ClipContext.Fluid.NONE, entity)).getBlockPos().getY()),
								(entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(scale)), ClipContext.Block.VISUAL, ClipContext.Fluid.NONE, entity)).getBlockPos().getZ()),
								20, 0.1, 0.1, 0.1, 0.1);
			...
			if (entity.getPersistentData().getDouble("EM_inferno_dragon_rail_gun_charging_tick") > 0) {
				entity.getPersistentData().putDouble("EM_inferno_dragon_rail_gun_charging_tick", (entity.getPersistentData().getDouble("EM_inferno_dragon_rail_gun_charging_tick") - 1));
			}
		}
	}
