...
@EventBusSubscriber
public class SuperZombieProcedure {
	@SubscribeEvent
					...
					if (Mth.nextInt(RandomSource.create(), 1, 2) == 1) {
						...
						if (Mth.nextInt(RandomSource.create(), 1, 2) == 1) {
							if (entity instanceof ZombifiedPiglin) {
								if (entity instanceof LivingEntity _livingEntity20 && _livingEntity20.getAttributes().hasAttribute(ExtremeMonstersModAttributes.HYPER_MOBS))
									_livingEntity20.getAttribute(ExtremeMonstersModAttributes.HYPER_MOBS).setBaseValue(1);
								if (entity instanceof LivingEntity _livingEntity21 && _livingEntity21.getAttributes().hasAttribute(Attributes.MAX_HEALTH))
									_livingEntity21.getAttribute(Attributes.MAX_HEALTH).setBaseValue(300);
								if (entity instanceof LivingEntity _entity)
								...
								if (entity instanceof LivingEntity _livingEntity24 && _livingEntity24.getAttributes().hasAttribute(Attributes.MAX_HEALTH))
									_livingEntity24.getAttribute(Attributes.MAX_HEALTH).setBaseValue(200);
								if (entity instanceof LivingEntity _entity)
