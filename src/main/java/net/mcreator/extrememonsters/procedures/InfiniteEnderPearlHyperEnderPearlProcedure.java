...
@EventBusSubscriber
public class InfiniteEnderPearlHyperEnderPearlProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ExtremeMonstersModItems.HYPER_ENDER_PEARL.get()
				&& !(entity instanceof Player _plrCldCheck2 && _plrCldCheck2.getCooldowns().isOnCooldown(ExtremeMonstersModItems.HYPER_ENDER_PEARL.get()))) {
			...
			if (entity instanceof Player _player)
				_player.getCooldowns().addCooldown(ExtremeMonstersModItems.HYPER_ENDER_PEARL.get(), 20);
		}
	}
}
