...
public class PerfectDarkMatterRadiationProcedure {
					...
					if (!projectileLevel.isClientSide()) {
						Projectile _entityToSpawn = new Object() {
							public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
								AbstractArrow entityToSpawn = new PerfectDarkMatterSubEntity(ExtremeMonstersModEntities.PERFECT_DARK_MATTER_SUB.get(), level) {
									@Override
