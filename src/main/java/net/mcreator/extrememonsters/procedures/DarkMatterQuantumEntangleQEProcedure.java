...
public class DarkMatterQuantumEntangleQEProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 128)).getItem() == ExtremeMonstersModItems.QUANTUM_ENTANGLER.get()) {
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 128)).copy();
			{
			...
			if (world instanceof ILevelExtension _ext && _ext.getCapability(Capabilities.ItemHandler.BLOCK, BlockPos.containing(x, y, z), null) instanceof IItemHandlerModifiable _itemHandlerModifiable) {
				...
				_itemHandlerModifiable.setStackInSlot(128, _setstack);
			}
			if (world instanceof ILevelExtension _ext && _ext.getCapability(Capabilities.ItemHandler.BLOCK, BlockPos.containing(x, y, z), null) instanceof IItemHandlerModifiable _itemHandlerModifiable) {
				ItemStack _setstack = Entangle_QE.copy();
				_setstack.setCount(1);
				_itemHandlerModifiable.setStackInSlot(129, _setstack);
			}
		}
	}
}
