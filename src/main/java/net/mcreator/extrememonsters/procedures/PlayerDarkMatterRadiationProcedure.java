...
public class PlayerDarkMatterRadiationProcedure {
					...
					if (!projectileLevel.isClientSide()) {
						Projectile _entityToSpawn = new Object() {
							public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
								AbstractArrow entityToSpawn = new PlayerWitheredDarkMatterSubEntity(ExtremeMonstersModEntities.PLAYER_WITHERED_DARK_MATTER_SUB.get(), level) {
									@Override
