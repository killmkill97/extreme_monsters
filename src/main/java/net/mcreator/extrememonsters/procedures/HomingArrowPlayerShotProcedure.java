...
@EventBusSubscriber
public class HomingArrowPlayerShotProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (CheckCanUseAbilityItemsProcedure.execute(entity, new ItemStack(ExtremeMonstersModItems.HYPER_STAFF.get()))) {
			{
				...
				for (Entity entityiterator : _entfound) {
					if (!(entity == entityiterator)) {
						if (entityiterator instanceof Mob) {
							entityiterator.push((entityiterator.getX() * 0.2 - entity.getX() * 0.2), 1.2, (entityiterator.getZ() * 0.2 - entity.getZ() * 0.2));
