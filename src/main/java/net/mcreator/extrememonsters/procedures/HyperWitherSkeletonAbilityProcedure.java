...
@EventBusSubscriber
public class HyperWitherSkeletonAbilityProcedure {
	@SubscribeEvent
		...
		if (entity instanceof WitherSkeleton) {
			if ((entity instanceof LivingEntity _livingEntity1 && _livingEntity1.getAttributes().hasAttribute(ExtremeMonstersModAttributes.HYPER_MOBS) ? _livingEntity1.getAttribute(ExtremeMonstersModAttributes.HYPER_MOBS).getBaseValue() : 0) == 1) {
				if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null)) {
					if ((entity instanceof LivingEntity _livingEntity4 && _livingEntity4.getAttributes().hasAttribute(ExtremeMonstersModAttributes.ON_HAND_SWORD)
							? _livingEntity4.getAttribute(ExtremeMonstersModAttributes.ON_HAND_SWORD).getBaseValue()
							: 0) == 1) {
						...
						if (entity.getPersistentData().getDouble("tp") <= 0) {
							if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null)) {
														...
														((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).level()
																.clip(new ClipContext((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getEyePosition(1f),
																		(entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)
																				.getEyePosition(1f).add((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getViewVector(1f).scale((-2))),
																		ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)))
																.getBlockPos().getX()),
														((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY()),
														((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).level()
								...
								if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getDirection()) == Direction.NORTH) {
									(entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).setDeltaMovement(new Vec3(0, 0.5, (-2)));
								}
								if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getDirection()) == Direction.SOUTH) {
									(entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).setDeltaMovement(new Vec3(0, 0.5, 2));
								}
								if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getDirection()) == Direction.WEST) {
									(entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).setDeltaMovement(new Vec3((-2), 0.5, 0));
								}
								if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getDirection()) == Direction.EAST) {
									(entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).setDeltaMovement(new Vec3(2, 0.5, 0));
								}
						...
						for (int index0 = 0; index0 < 4; index0++) {
							{
								...
								if (!projectileLevel.isClientSide()) {
									...
									}.getArrow(projectileLevel, entity, 2, 1, (byte) 999);
