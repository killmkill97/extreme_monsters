...
public class ZioItemDestinationExportProcedure {
	public static String execute(LevelAccessor world, double x, double y, double z) {
		...
		if (!((world.getBlockState(BlockPos.containing(dn_x, dn_y, dn_z))).getBlock() == Blocks.AIR)) {
			return (world.getBlockState(BlockPos.containing(dn_x, dn_y, dn_z))).getBlock().getName().getString();
		}
