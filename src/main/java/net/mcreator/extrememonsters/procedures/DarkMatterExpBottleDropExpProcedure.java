...
public class DarkMatterExpBottleDropExpProcedure {
	public static void execute(LevelAccessor world, Entity immediatesourceentity) {
		...
		if (world instanceof ServerLevel _level)
			_level.addFreshEntity(new ExperienceOrb(_level, (immediatesourceentity.getX()), (immediatesourceentity.getY()), (immediatesourceentity.getZ()), (int) Mth.nextDouble(RandomSource.create(), 4800, 8000)));
