...
public class BlackHoleBombProjectileBoomProcedure {
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof Mob) {
						if (new Object() {
							...
							entityiterator.push((entityiterator.getX() * 0.5 - x * 0.5), (entityiterator.getY() * 0.5 - y * 0.5), (entityiterator.getZ() * 0.5 - z * 0.5));
						} else {
							entityiterator.push((entityiterator.getX() * 0.5 - x * 0.5), (entityiterator.getY() * 0.5 - y * 0.5), (entityiterator.getZ() * 0.5 - z * 0.5));
						}
						entityiterator.hurt(new DamageSource(world.holderOrThrow(DamageTypes.GENERIC)), 50);
					}
				}
			}
			if (world instanceof Level _level) {
