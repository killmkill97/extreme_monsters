...
@EventBusSubscriber
public class StasisRailGunUseProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ExtremeMonstersModItems.STASIS_RAIL_GUN.get()
				...
				}.checkGamemode(entity)) && !entity.getPersistentData().getBoolean("EM_stasis_rail_gun_charging")
			...
			entity.getPersistentData().putBoolean("EM_stasis_rail_gun_charging", true);
