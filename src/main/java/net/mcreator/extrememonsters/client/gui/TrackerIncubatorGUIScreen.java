...
public class TrackerIncubatorGUIScreen extends AbstractContainerScreen<TrackerIncubatorGUIMenu> {
	private final static HashMap<String, Object> guistate = TrackerIncubatorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TrackerIncubatorGUIScreen(TrackerIncubatorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/tracker_incubator_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.tracker_incubator_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
