...
public class IronGeneratorGUIScreen extends AbstractContainerScreen<IronGeneratorGUIMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/iron_generator_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.iron_generator_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
