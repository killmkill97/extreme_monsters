...
public class TearExtractorGUIScreen extends AbstractContainerScreen<TearExtractorGUIMenu> {
	private final static HashMap<String, Object> guistate = TearExtractorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TearExtractorGUIScreen(TearExtractorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/tear_extractor_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("extreme_monsters:textures/screens/ghast_tear.png"), this.leftPos + 29, this.topPos + 29, 0, 0, 32, 32, 32, 32);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.tear_extractor_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
