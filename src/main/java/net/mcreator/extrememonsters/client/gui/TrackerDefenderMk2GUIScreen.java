...
public class TrackerDefenderMk2GUIScreen extends AbstractContainerScreen<TrackerDefenderMk2GUIMenu> {
	private final static HashMap<String, Object> guistate = TrackerDefenderMk2GUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TrackerDefenderMk2GUIScreen(TrackerDefenderMk2GUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/tracker_defender_mk_2_gui.png");
