...
public class DarkMatterGeneratorGUIScreen extends AbstractContainerScreen<DarkMatterGeneratorGUIMenu> {
	private final static HashMap<String, Object> guistate = DarkMatterGeneratorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public DarkMatterGeneratorGUIScreen(DarkMatterGeneratorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/dark_matter_generator_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.dark_matter_generator_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
