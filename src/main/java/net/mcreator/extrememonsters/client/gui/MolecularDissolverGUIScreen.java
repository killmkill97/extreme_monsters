...
public class MolecularDissolverGUIScreen extends AbstractContainerScreen<MolecularDissolverGUIMenu> {
	private final static HashMap<String, Object> guistate = MolecularDissolverGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MolecularDissolverGUIScreen(MolecularDissolverGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/molecular_dissolver_gui.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 125 && mouseX < leftPos + 149 && mouseY > topPos + 34 && mouseY < topPos + 58)
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("extreme_monsters:textures/screens/molecular_solvent_bucket.png"), this.leftPos + 129, this.topPos + 39, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.molecular_dissolver_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
