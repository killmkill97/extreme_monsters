...
public class SoulInputMachineGUIScreen extends AbstractContainerScreen<SoulInputMachineGUIMenu> {
	private final static HashMap<String, Object> guistate = SoulInputMachineGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public SoulInputMachineGUIScreen(SoulInputMachineGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/soul_input_machine_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.soul_input_machine_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
