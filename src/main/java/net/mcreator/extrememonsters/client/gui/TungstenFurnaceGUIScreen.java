...
public class TungstenFurnaceGUIScreen extends AbstractContainerScreen<TungstenFurnaceGUIMenu> {
	private final static HashMap<String, Object> guistate = TungstenFurnaceGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TungstenFurnaceGUIScreen(TungstenFurnaceGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/tungsten_furnace_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.tungsten_furnace_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
