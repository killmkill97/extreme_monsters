...
public class MatterCatalystCompressorGUIScreen extends AbstractContainerScreen<MatterCatalystCompressorGUIMenu> {
	private final static HashMap<String, Object> guistate = MatterCatalystCompressorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MatterCatalystCompressorGUIScreen(MatterCatalystCompressorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/matter_catalyst_compressor_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.matter_catalyst_compressor_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
