...
public class WitherIncubatorGUIScreen extends AbstractContainerScreen<WitherIncubatorGUIMenu> {
	private final static HashMap<String, Object> guistate = WitherIncubatorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public WitherIncubatorGUIScreen(WitherIncubatorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/wither_incubator_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.wither_incubator_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
