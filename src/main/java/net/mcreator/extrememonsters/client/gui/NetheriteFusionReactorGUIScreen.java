...
public class NetheriteFusionReactorGUIScreen extends AbstractContainerScreen<NetheriteFusionReactorGUIMenu> {
	private final static HashMap<String, Object> guistate = NetheriteFusionReactorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public NetheriteFusionReactorGUIScreen(NetheriteFusionReactorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/netherite_fusion_reactor_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.netherite_fusion_reactor_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
