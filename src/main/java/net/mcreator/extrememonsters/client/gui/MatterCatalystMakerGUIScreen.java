...
import net.mcreator.extrememonsters.procedures.SkyLightDiplayProcedure;
...
public class MatterCatalystMakerGUIScreen extends AbstractContainerScreen<MatterCatalystMakerGUIMenu> {
	private final static HashMap<String, Object> guistate = MatterCatalystMakerGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MatterCatalystMakerGUIScreen(MatterCatalystMakerGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/matter_catalyst_maker_gui.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 2 && mouseX < leftPos + 26 && mouseY > topPos + 58 && mouseY < topPos + 82)
			guiGraphics.renderTooltip(font, Component.literal(FluidDisplayProcedure.execute(world, x, y, z)), mouseX, mouseY);
		if (mouseX > leftPos + 31 && mouseX < leftPos + 55 && mouseY > topPos + 32 && mouseY < topPos + 56)
			guiGraphics.renderTooltip(font, Component.literal(SkyLightDiplayProcedure.execute(world, x, y, z)), mouseX, mouseY);
	}
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("extreme_monsters:textures/screens/water_bucket.png"), this.leftPos + 5, this.topPos + 63, 0, 0, 16, 16, 16, 16);

		guiGraphics.blit(ResourceLocation.parse("extreme_monsters:textures/screens/light_15.png"), this.leftPos + 35, this.topPos + 36, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.matter_catalyst_maker_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
