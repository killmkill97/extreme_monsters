...
public class MolecularAssemblerGUIScreen extends AbstractContainerScreen<MolecularAssemblerGUIMenu> {
	private final static HashMap<String, Object> guistate = MolecularAssemblerGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MolecularAssemblerGUIScreen(MolecularAssemblerGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/molecular_assembler_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("extreme_monsters:textures/screens/molecule.png"), this.leftPos + 26, this.topPos + 38, 0, 0, 18, 18, 18, 18);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.molecular_assembler_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
