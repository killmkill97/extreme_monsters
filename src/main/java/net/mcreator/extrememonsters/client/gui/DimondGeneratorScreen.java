...
public class DimondGeneratorScreen extends AbstractContainerScreen<DimondGeneratorMenu> {
	private final static HashMap<String, Object> guistate = DimondGeneratorMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public DimondGeneratorScreen(DimondGeneratorMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/dimond_generator.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.dimond_generator.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
