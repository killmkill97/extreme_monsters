...
import net.mcreator.extrememonsters.network.InfinityMatrixGUIButtonMessage;

import java.util.HashMap;

import com.mojang.blaze3d.systems.RenderSystem;

public class InfinityMatrixGUIScreen extends AbstractContainerScreen<InfinityMatrixGUIMenu> {
	private final static HashMap<String, Object> guistate = InfinityMatrixGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	ImageButton imagebutton_lock_item_buttom;

	public InfinityMatrixGUIScreen(InfinityMatrixGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/infinity_matrix_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.infinity_matrix_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	...
	public void init() {
		...
		imagebutton_lock_item_buttom = new ImageButton(this.leftPos + 106, this.topPos + 60, 16, 16,
				new WidgetSprites(ResourceLocation.parse("extreme_monsters:textures/screens/lock_item_buttom.png"), ResourceLocation.parse("extreme_monsters:textures/screens/lock_item_buttom.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new InfinityMatrixGUIButtonMessage(0, x, y, z));
						InfinityMatrixGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
