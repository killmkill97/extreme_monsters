...
public class AppleCultivatorGUIScreen extends AbstractContainerScreen<AppleCultivatorGUIMenu> {
	private final static HashMap<String, Object> guistate = AppleCultivatorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public AppleCultivatorGUIScreen(AppleCultivatorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/apple_cultivator_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.apple_cultivator_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
	}
