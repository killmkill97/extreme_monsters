...
public class MolecularAlloyingForgeGUIScreen extends AbstractContainerScreen<MolecularAlloyingForgeGUIMenu> {
	private final static HashMap<String, Object> guistate = MolecularAlloyingForgeGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MolecularAlloyingForgeGUIScreen(MolecularAlloyingForgeGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("extreme_monsters:textures/screens/molecular_alloying_forge_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("extreme_monsters:textures/screens/molecular_solvent_bucket.png"), this.leftPos + 118, this.topPos + 63, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.molecular_alloying_forge_gui.label_dark_matter_generator"), 5, 6, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.extreme_monsters.molecular_alloying_forge_gui.label_alloying_forge"), 5, 15, -12829636, false);
	}
