...
public class BlackHoleBombProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(ExtremeMonstersModItems.BLACK_HOLE_BOMB.get());
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(ExtremeMonstersModItems.BLACK_HOLE_BOMB.get());
	}
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		BlackHoleBombProjectileBoomProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		BlackHoleBombProjectileBoomProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ(), this);
	}
	...
	public static BlackHoleBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BlackHoleBombProjectileEntity entityarrow = new BlackHoleBombProjectileEntity(ExtremeMonstersModEntities.BLACK_HOLE_BOMB_PROJECTILE.get(), entity, world, null);
	...
	public static BlackHoleBombProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		BlackHoleBombProjectileEntity entityarrow = new BlackHoleBombProjectileEntity(ExtremeMonstersModEntities.BLACK_HOLE_BOMB_PROJECTILE.get(), entity, entity.level(), null);
