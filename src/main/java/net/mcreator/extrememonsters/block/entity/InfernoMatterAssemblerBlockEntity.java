...
public class InfernoMatterAssemblerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public InfernoMatterAssemblerBlockEntity(BlockPos position, BlockState state) {
		super(ExtremeMonstersModBlockEntities.INFERNO_MATTER_ASSEMBLER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("inferno_matter_assembler");
	}
