...
public class MatterCatalystMakerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(4, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public MatterCatalystMakerBlockEntity(BlockPos position, BlockState state) {
		super(ExtremeMonstersModBlockEntities.MATTER_CATALYST_MAKER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("matter_catalyst_maker");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new MatterCatalystMakerGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
