...
public class DarkMatterAssemblerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public DarkMatterAssemblerBlockEntity(BlockPos position, BlockState state) {
		super(ExtremeMonstersModBlockEntities.DARK_MATTER_ASSEMBLER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("dark_matter_assembler");
	}
