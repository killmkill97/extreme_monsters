...
public class InfinityMatrixBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public InfinityMatrixBlockEntity(BlockPos position, BlockState state) {
		super(ExtremeMonstersModBlockEntities.INFINITY_MATRIX.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("infinity_matrix");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new InfinityMatrixGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
