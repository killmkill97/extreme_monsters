...
public class MolecularDissolverBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(6, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public MolecularDissolverBlockEntity(BlockPos position, BlockState state) {
		super(ExtremeMonstersModBlockEntities.MOLECULAR_DISSOLVER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("molecular_dissolver");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new MolecularDissolverGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(5000000, 2147483647, 2147483647, 0) {
		@Override
