...
public class IceMakerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(3, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public IceMakerBlockEntity(BlockPos position, BlockState state) {
		super(ExtremeMonstersModBlockEntities.ICE_MAKER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("ice_maker");
	}
	...
	private final FluidTank fluidTank = new FluidTank(500000, fs -> {
