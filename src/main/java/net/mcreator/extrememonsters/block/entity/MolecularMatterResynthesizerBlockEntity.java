...
public class MolecularMatterResynthesizerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private final EMItemHandler inventory = new EMItemHandler(
	    7, //원하는 슬롯수
	    new boolean[]{ true, true, true, true, false, false, false},      // canInsert
	    new boolean[]{ false, false, false, false, true, false, false} // canExtract
	);

	public MolecularMatterResynthesizerBlockEntity(BlockPos position, BlockState state) {
		super(ExtremeMonstersModBlockEntities.MOLECULAR_MATTER_RESYNTHESIZER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("molecular_matter_resynthesizer");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new MolecularMatterResynthesizerGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(15000000, 2147483647, 2147483647, 0) {
		@Override
