...
public class EnergizingRecipe implements Recipe<RecipeInput> {
	...
	public EnergizingRecipe(ItemStack output, NonNullList<Ingredient> recipeItems) {
		this.output = output;
	...
	public static class Type implements RecipeType<EnergizingRecipe> {
		private Type() {
		}

		public static final RecipeType<EnergizingRecipe> INSTANCE = new Type();
	}

	public static class Serializer implements RecipeSerializer<EnergizingRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		private static final MapCodec<EnergizingRecipe> CODEC = RecordCodecBuilder
				...
				}, DataResult::success).forGetter(recipe -> recipe.recipeItems)).apply(builder, EnergizingRecipe::new));
		...
		private static EnergizingRecipe fromNetwork(RegistryFriendlyByteBuf buf) {
			...
			return new EnergizingRecipe(ItemStack.STREAM_CODEC.decode(buf), inputs);
		}

		private static void toNetwork(RegistryFriendlyByteBuf buf, EnergizingRecipe recipe) {
