...
public class AssemblerRecipe implements Recipe<RecipeInput> {
	private final ItemStack output;
	private final NonNullList<Ingredient> recipeItems;

	public AssemblerRecipe(ItemStack output, NonNullList<Ingredient> recipeItems) {
		this.output = output;
	...
	public static class Type implements RecipeType<AssemblerRecipe> {
		...
		public static final RecipeType<AssemblerRecipe> INSTANCE = new Type();
	}

	public static class Serializer implements RecipeSerializer<AssemblerRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		private static final MapCodec<AssemblerRecipe> CODEC = RecordCodecBuilder
				...
				}, DataResult::success).forGetter(recipe -> recipe.recipeItems)).apply(builder, AssemblerRecipe::new));
		public static final StreamCodec<RegistryFriendlyByteBuf, AssemblerRecipe> STREAM_CODEC = StreamCodec.of(Serializer::toNetwork, Serializer::fromNetwork);
		...
		private static AssemblerRecipe fromNetwork(RegistryFriendlyByteBuf buf) {
			...
			return new AssemblerRecipe(ItemStack.STREAM_CODEC.decode(buf), inputs);
		}
