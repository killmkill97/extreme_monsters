...
public class CompressionRecipe implements Recipe<RecipeInput> {
	private final ItemStack output;
	private final NonNullList<Ingredient> recipeItems;

	public CompressionRecipe(ItemStack output, NonNullList<Ingredient> recipeItems) {
		this.output = output;
	...
	public static class Type implements RecipeType<CompressionRecipe> {
		...
		public static final RecipeType<CompressionRecipe> INSTANCE = new Type();
	}

	public static class Serializer implements RecipeSerializer<CompressionRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		private static final MapCodec<CompressionRecipe> CODEC = RecordCodecBuilder
				...
				}, DataResult::success).forGetter(recipe -> recipe.recipeItems)).apply(builder, CompressionRecipe::new));
		public static final StreamCodec<RegistryFriendlyByteBuf, CompressionRecipe> STREAM_CODEC = StreamCodec.of(Serializer::toNetwork, Serializer::fromNetwork);
		...
		private static CompressionRecipe fromNetwork(RegistryFriendlyByteBuf buf) {
			...
			return new CompressionRecipe(ItemStack.STREAM_CODEC.decode(buf), inputs);
		}

		private static void toNetwork(RegistryFriendlyByteBuf buf, CompressionRecipe recipe) {
